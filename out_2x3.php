...
<head>
    <!--- Basic Page Needs  -->
    <meta charset="utf-8">
    <title>Pure Strategy 2x3 | Final RO</title>
  	...
  	<div class="container contact-form">
	    <form method="post" action="">
	        ...
	        <?php
				...
				$data = array(array($a,$b,$c), array($d,$e,$f));
				     	...
				     	echo"<h5>START MATRIKS</h5>";
				      	echo"<table border='2'>";
				      		echo"<tr align='center'>";
					            ...
					            echo "<td colspan='3'><b> PEMAIN B </b></td>";
				        	echo"</tr>";
				        	echo"<tr align='center'>";
					        	$z=0;
					          	for($i=0; $i<$kolom; $i++)
				...
				$kosong = " ";
				$datanew = array(array($a,$b,$c, $min1), array($d,$e,$f,$min2));
				$datamax = array($max1,$max2,$max3,$kosong);
